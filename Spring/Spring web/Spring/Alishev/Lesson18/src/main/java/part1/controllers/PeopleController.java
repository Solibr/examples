...
public class PeopleController {
    ...
    // указываем параметр метода, в котором нужно включать валидацию с помощью @Valid. Обязательно следующим параметром после проверяемого должен идти BindingResult
    @PostMapping()
    public String postPerson(@ModelAttribute("person") @Valid Person person, BindingResult bindingResult) {

        // при наличии ошибок, они встроятся в поля объекта, и мы возвращаемся обратно в эту же форму, где были ошибки
